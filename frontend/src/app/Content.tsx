  ...
  return (
      <ThemeProvider theme={defaultTheme}>
        ...
        <SnackbarProvider maxSnack={5} autoHideDuration={3000}>
          <Stack direction="row" height={"100vh"} maxHeight={"100vh"} width={"100vw"} maxWidth={"100vw"}>
            <SideBar />
            <Stack width={"100%"} height={"100%"} maxHeight={"100%"} maxWidth={"100%"} >
              <TopBar />
              <Stack padding={10} alignItems={"center"} height={"100%"}>
                <Paper elevation={5} variant="outlined">
                  <Stack padding={2} justifyContent={"center"} alignItems={"center"} spacing={5}>
                    {children}
                  </Stack>
                </Paper>
              </Stack>
